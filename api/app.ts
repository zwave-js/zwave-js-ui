...
import { GatewayFactory } from '#api/runtime/GatewayFactory'
import hassDevices from '#api/hass/devices'
import jsonStore from '#api/lib/jsonStore'
import * as loggers from '#api/lib/logger'
import SocketManager from '#api/lib/SocketManager'
...
} from '#api/lib/externalSettings'
import { readFile, writeFile } from 'node:fs/promises'
import { generate } from 'selfsigned'
import { Driver } from 'zwave-js'
import debugManager from '#api/lib/DebugManager'
import { AppRuntime, isAuthEnabled } from '#api/runtime/AppRuntime'
import type { GatewayPort, ZnifferPort } from '#api/runtime/ports'
import type { JwtUserPayload } from '#api/routes/auth'
import { registerAuthRoutes } from '#api/routes/auth'
import { registerHealthRoutes } from '#api/routes/health'
import { registerSettingsRoutes } from '#api/routes/settings'
import { registerImportExportRoutes } from '#api/routes/importExport'
import { registerConfigurationTemplatesRoutes } from '#api/routes/configurationTemplates'
import { registerStoreRoutes } from '#api/routes/store'
import { registerDebugRoutes } from '#api/routes/debug'
import { registerSocketApi } from '#api/socket/registerSocketApi'
