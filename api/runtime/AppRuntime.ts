...
import ZWaveClient from '#api/lib/ZwaveClient'
import type { ZnifferConfig } from '#api/lib/ZnifferManager'
import ZnifferManager from '#api/lib/ZnifferManager'
import type { CustomPlugin, PluginConstructor } from '#api/lib/CustomPlugin'
import { createPlugin } from '#api/lib/CustomPlugin'
import backupManager from '#api/lib/BackupManager'
import HomeAssistantManager from '#api/hass/HomeAssistantManager'
import MqttDiscoveryManager from '#api/hass/MqttDiscoveryManager'
import ZwaveServerManager from '#api/hass/ZwaveServerManager'
 ...
 *    this state is reported by `restarting`, so a restart stays "restarting"
...
export class AppRuntime {
	...
	// ordering and the restart guard (see `restarting`/`setRestarting()` and
	...
	constructor(deps: AppRuntimeDeps) {
		...
		// starts the lifecycle in `stopping`, so `restarting` stays true until
