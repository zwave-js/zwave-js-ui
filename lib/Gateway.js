...
Gateway.prototype.discoverClimates = function (node) {
  ...
  try {
    ...
    if (temperatureId) {
      ...
      config.discovery_payload.current_temperature_template = undefined
    ...
    if (modeId) {
      ...
      config.discovery_payload.modes = undefined
      config.discovery_payload.mode_state_template = undefined
    }
