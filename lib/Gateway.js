 ...
 * @returns {boolean} true if the rgb dimmer is added, false otherwise
 */
    ...
    switch (cmdClass) {
      ...
      case CommandClasses['Binary Toggle Switch']:
        if (valueId.isCurrentValue) {
          if (!addRgbDimmer.call(this, hassCfg.light_rgb_switch, node, valueId)) {
      ...
      case CommandClasses['Multilevel Toggle Switch']:
        if (valueId.isCurrentValue) {
          ...
          if (
            ...
            // brightness level
            if (addRgbDimmer.call(this, hassCfg.light_rgb_dimmer, node, valueId)) {
      ...
      case 'color':
        if (valueId.property === 'hexColor') {
          addRgbDimmer.call(this, hassCfg.light_rgb_switch, node, valueId)
        } else return
        break
      default:
        return
