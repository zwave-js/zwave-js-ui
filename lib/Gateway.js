...
function addRgbColorSwitch (cfg, node, valueId) {
  ...
  */
  ...
  if (node.values['51-0-currentcolor']) {
    cfg.discovery_payload.color_temp_state_topic = '51-0-currentColor'
    ...
    cfg.discovery_payload.color_temp_command_topic = '51-0-targetColor'
