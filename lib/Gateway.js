    ...
    switch (cmdClass) {
      ...
      case CommandClasses['Binary Sensor']:
        ...
        switch (sensorTypeName) {
          ...
          case 'co2':
          case 'tamper':
            cfg.discovery_payload.device_class = Constants.deviceClass.sensor_binary.SAFETY
            break
          // problem - normal
          case 'alarm':
          ...
          // battery - normal
          case 'battery_low':
            cfg.discovery_payload.device_class = Constants.deviceClass.sensor_binary.BATTERY
            break
        }
