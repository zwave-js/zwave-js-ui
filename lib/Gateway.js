...
Gateway.prototype.parsePayload = function (payload, value, valueConf) {
  ...
  if (value.type === 'list' && value.values.indexOf(payload) < 0) {
    var hassDevice = this.discovered[value.value_id]
    payload = hassDevice && hassDevice.mode_map ? hassDevice.mode_map[payload] : payload
  }
...
Gateway.prototype.publishDiscovery = function (hassDevice, deleteDevice) {
