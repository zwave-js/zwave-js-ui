...
/**
 *
 * @param {Object} node any node payload
 * @param {Object} valueId valueId object
 * @param {Object} cfg configuration object
 * @param {String} entityTemplate gateway.entityTemplate string
 */
function getEntityName (node, valueId, cfg, entityTemplate) {
  entityTemplate = entityTemplate || '%loc-%n_%ob'
  let propertyKey = cfg.object_id
  let propertyName = cfg.object_id
