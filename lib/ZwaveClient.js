...
ZwaveClient.prototype.setConfigParameter = async function (
  nodeId,
  parameter,
  value,
  valueSize
) {
  if (this.closed || !this.driverReady) {
    throw Error('Driver is closed')
  }
  ...
  await node.commandClasses.Configuration.set(parameter, value, valueSize)
}
