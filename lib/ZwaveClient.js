...
class ZwaveClient extends EventEmitter {
  ...
  */
   ...
   *
   * @param {import('zwave-js').ZWaveNode} zwaveNode
   * @returns {Promise<import('../types/index.js').Z2MNode>}
   */
  async _addNode (zwaveNode) {
    ...
    // bind to node events before everything else to prevent race conditions
