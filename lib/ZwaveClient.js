 ...
 *
 * @param {any[]} scenes The scenes Array
 ...
 *
 * @param {number} sceneid The scene id
 * @param {import('../types/index.js').Z2MValueId} valueId internal valueId
 ...
 *
 * @param {number} sceneid The scene id
 * @param {import('../types/index.js').Z2MValueId} valueId The valueId to remove
 * @throws Error if args valueid isn't valid
 */
