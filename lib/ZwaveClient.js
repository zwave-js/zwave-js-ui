...
function findTargetValue (zwaveValue, definedValueIds) {
  return definedValueIds.find(v => v.commandClass === zwaveValue.commandClass && v.endpoint === zwaveValue.endpoint && v.propertyKey === zwaveValue.propertyKey && /target/i.test(v.propertyName))
}
